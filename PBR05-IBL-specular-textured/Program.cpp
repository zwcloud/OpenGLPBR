...
//Global
HINSTANCE globalHInstance = nullptr;
HDC hDC = nullptr;
...
BOOL InitOpenGL(HWND hWnd)
{
    ...
    glUniform1i(uniformAlbedoMap, 3);
    glUniform1i(uniformNormalMap, 4);
    glUniform1i(uniformMetallicMap, 5);
    glUniform1i(uniformRoughnessMap, 6);
    glUniform1i(uniformAoMap, 7);
...
int __stdcall WinMain(__in HINSTANCE hInstance, __in_opt HINSTANCE hPrevInstance, __in_opt LPSTR lpCmdLine, __in int nShowCmd)
{
    ...
    wc.lpszClassName = L"PBR05-IBL-specular-texturedWindowClass";
    wc.style = CS_OWNDC;
    if (!RegisterClass(&wc))
        return 1;
    HWND hWnd = CreateWindowW(wc.lpszClassName, L"PBR05-IBL-specular-textured", WS_OVERLAPPEDWINDOW | WS_VISIBLE, 0, 0, 800, 600, 0, 0, hInstance, 0);
